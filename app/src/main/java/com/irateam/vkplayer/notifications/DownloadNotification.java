...
public class DownloadNotification {
    ...
    public static Notification create(Context context, VKApiAudio audio, int progress) {
    ...
    public static void update(Context context, VKApiAudio audio, int progress) {
