...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* new UserService(this).getCurrentUser(SimpleCallback.of(user -> {
    ...
    public boolean onNavigationItemSelected(MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            case R.id.current_playlist:
                audioService.getCurrent().execute(this);
                break;

            case R.id.my_audio:
                audioService.getMy().execute(this);
                return true;
            case R.id.recommended_audio:
                audioService.getRecommendation().execute(this);
                return true;
            case R.id.popular_audio:
                audioService.getPopular().execute(this);
                return true;
            case R.id.cached_audio:
                audioService.getCached().execute(this);
                return true;
            case R.id.settings:
